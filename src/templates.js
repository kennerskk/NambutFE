export const TEMPLATES = {
  ...
  minimal: {
    ...
    desktopElements: [
      { id: 'm1', type: 'text', content: 'JANE DOE', x: 80, y: 220, w: 400, h: 60, z: 1, style: { fontSize: '48px', fontFamily: 'Inter', fontWeight: 'bold', textAlign: 'left', justifyContent: 'flex-start', color: '#0f172a' } },
      { id: 'm2', type: 'text', content: 'Creative Director', x: 80, y: 290, w: 400, h: 40, z: 2, style: { fontSize: '20px', fontFamily: 'Inter', fontWeight: 'normal', textAlign: 'left', justifyContent: 'flex-start', color: '#64748b' } },
      { id: 'm3', type: 'button', content: 'https://linkedin.com/in/jane', x: 80, y: 350, w: 150, h: 50, z: 3, style: { background: '#0f172a', color: '#ffffff', borderRadius: '8px', justifyContent: 'center' } },
